// apps/catalog-service/src/infrastructure/outbox/outbox.repository.ts

import { OutboxEntity } from '../../domain/entities/outbox.entity';
import { OutboxModel } from '../persistence/mongoose/models/outbox.model';
import { IOutboxRepository } from '../persistence/mongoose/repositories/outbox.repositories.impl';
